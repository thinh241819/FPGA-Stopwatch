...
HD_PWD='E:/CSM152/Lab_3/Official_Project/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log the_whole_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source the_whole_clock.tcl -notrace
