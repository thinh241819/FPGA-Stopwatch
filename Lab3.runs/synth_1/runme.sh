...
HD_PWD='E:/CSM152/Lab_3/Official_Project/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log the_whole_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source the_whole_clock.tcl
